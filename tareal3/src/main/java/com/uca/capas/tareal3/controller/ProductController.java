...
public class ProductController {
	...
	public ModelAndView compraProducto() {
		...
		productos.add(new Product(0, "Agua", 50));
		productos.add(new Product(1, "Cafe", 35));
		productos.add(new Product(2, "Splenda", 55));
		productos.add(new Product(3, "Manzana", 20));
		productos.add(new Product(4, "Hielo", 30));
